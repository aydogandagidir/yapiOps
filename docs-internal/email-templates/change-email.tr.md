...
>
  ...
  <p style="line-height: 1.6; margin: 0 0 24px;">
    YapıOps hesabınızda e-posta adresinizin değişmesi talep edildi. Yeni adres:
  ...
  >
    <p style="line-height: 1.5; margin: 0; font-size: 14px; color: #78350f;">
      <strong>Güvenlik notu:</strong> Bu değişikliği siz talep etmediyseniz bu e-postayı yok sayın
      ve şifrenizi hemen değiştirin.
    </p>
  </div>
