...
>
  ...
  <p style="line-height: 1.6; margin: 0 0 24px;">
    YapıOps hesabınızın şifresini sıfırlama isteği aldık. Yeni bir şifre belirlemek için aşağıdaki
    butona tıklayın:
  </p>
  ...
  <div
    style="background: #fef3c7; border-left: 4px solid #f59e0b; padding: 12px 16px; margin: 16px 0; border-radius: 4px;"
  >
    <p style="line-height: 1.5; margin: 0; font-size: 14px; color: #78350f;">
      <strong>Güvenlik notu:</strong> Bu işlemi siz başlatmadıysanız bu e-postayı yok
      sayabilirsiniz. Şifreniz bu link tıklanmadığı sürece değişmez.
    </p>
  </div>
